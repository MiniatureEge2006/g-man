...
extensions = ['cogs.audio', 'cogs.help', 'cogs.code', 'cogs.exif', 'cogs.ffmpeg', 'cogs.tutorial', 'cogs.imagemagick', 'cogs.ytdlp', 'cogs.info', 'cogs.ai', 'cogs.reminder', 'cogs.roblox', 'cogs.search', 'cogs.tags', 'cogs.media', 'cogs.moderation']
