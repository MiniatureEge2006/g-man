...
class Media(commands.Cog):
    ...
    async def run_gscript_command(
        ...
        **kwargs,
        ...
        try:
            ...
            final_name = (
                f"{custom_name}.{ext}" if custom_name else f"{command_name}.{ext}"
            )
    ...
    @media.group(
        name="image", with_app_command=True, description="Image manipulation commands."
    )
    async def image(self, ctx: commands.Context):
        return

    @media.group(
        name="video", with_app_command=True, description="Video manipulation commands."
    )
    async def video(self, ctx: commands.Context):
        return

    @media.group(
        name="audio", with_app_command=True, description="Audio manipulation commands."
    )
    ...
    @media.group(
        ...
        description="Audio/Video manipulation commands.",
    )
    ...
    @media.group(
        name="iv",
        with_app_command=True,
        description="Image/Video manipulation commands.",
    )
    ...
    @media.command(
        ...
        description="Replace a video/audio/image's audio with another audio.",
    )
    @app_commands.describe(
        url="URL/Emoji/User.",
        attachment="Media file.",
    ...
    @media.command(
        name="audioputmix",
        description="Mix a video/audio/image's audio with another audio.",
    )
    @app_commands.describe(
        url="URL/Emoji/User.",
        attachment="Media file.",
    ...
    async def caption(
        ...
        text: str = "",
        font_size: int = 0,
        font: str = "Futura Condensed Extra Bold",
        color: str = "#000000",
    ...
    @app_commands.describe(
        url="URL/Emoji/User.", attachment="Video/Image file.", fps="FPS to set."
    )
    async def fps(
        self,
        ctx: commands.Context,
    ...
    @app_commands.describe(
        url="URL/Emoji/User.",
        attachment="Image/Video file.",
        hue_shift="Hue shift degrees. Also supports expressions from ffmpeg.",
    )
    async def hue(
        self,
        ctx: commands.Context,
    ...
    @app_commands.describe(
        url="URL/Emoji/User.",
        attachment="Image/Video file.",
        width="Width in pixels or expression. (e.g., '50%', 'iw/2')",
        height="Height in pixels or expression. (e.g., '50%', 'ih/2')",
    )
    async def resize(
        self,
        ctx: commands.Context,
    ...
    @app_commands.describe(
        url="URL/Emoji/User.",
        attachment="Image/Video file.",
        angle="Rotation angle in degrees. Supports expressions from ffmpeg.",
    )
    async def rotate(
        self,
        ctx: commands.Context,
    ...
    @iv.command(
        name="fadeout", description="Apply fade-out effect to a video or image."
    )
    @app_commands.describe(
        url="URL/Emoji/User.",
        attachment="Image/Video file.",
    ...
    async def overlay(
        ...
        overlay_parsed = await self.process_media_input(
            ctx, overlay_url, overlay_attachment
        )
        if overlay_parsed[2]:
    ...
    @app_commands.describe(
        url="URL/Emoji/User.",
        attachment="Image/Video file.",
        color="FFmpeg color name or hex code.",
        similarity="How much the color should be similar in order to be transparent.",
        blend="Level of transparency. 0.0 results in full transparency, while higher values result in semi.",
    )
    async def colorkey(
        self,
        ctx: commands.Context,
    ...
    @av.command(
        name="tremolo", description="Apply tremolo effect to an audio or video."
    )
    @app_commands.describe(
        url="URL/Emoji/User.",
        attachment="Audio/Video file.",
    ...
    @av.command(
        name="vibrato", description="Apply vibrato effect to an audio or video."
    )
    @app_commands.describe(
        url="URL/Emoji/User.",
        attachment="Audio/Video file.",
